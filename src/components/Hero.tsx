    ...
    return (
        <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-luxury-black">
            ...
            <div className="absolute inset-0 z-0 bg-luxury-black overflow-hidden">
                {/* Cinematic Image Background Base */}
                <motion.div style={{ y: y1 }} className="absolute inset-0 z-0 overflow-hidden">
                    <motion.img
                        ...
                        alt="Cinematic Abstract Background"
            ...
            >
                ...
                >
                    Crafting Cinematic Stories That <br className="hidden sm:block" />
                    <span className="italic text-transparent bg-clip-text bg-gradient-to-r from-off-white to-gold/70 pr-2 pb-2">Elevate Your Brand</span>.
                </motion.h1>
                ...
                >
                    ...
                    >
                        ...
                        View Our Work <Play size={14} fill="currentColor" />
                    </motion.a>
